    ...
    <div className="p-6 bg-white rounded-lg shadow-md">
      ...
      <div className="space-y-3">
        ...
        <div className="flex justify-between">
          ...
          <span className="text-right text-gray-800">{pump.cliente.direccion}</span>
        </div>
        <div className="flex justify-between">
          <span className="font-semibold text-gray-600">Ubicación Bomba:</span>
          <span className="text-right text-gray-800">{pump.ubicacion}</span>
        </div>
        <div className="flex justify-between">
          <span className="font-semibold text-gray-600">Último Mant.:</span>
          <span className="text-right text-gray-800">{pump.ultima_fecha_mantenimiento}</span>
        </div>
